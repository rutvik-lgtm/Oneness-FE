      ...
      <div className="green-footer-container">
          ...
          <div className="green-footer-col green-contact-col">
            ...
            <div className="green-contact-details">
              ...
              <p>
                ...
                <a href="tel:+919251844444">+91- 9251844444</a><br/>
                <a href="tel:+919772211111">+91- 9772211111</a><br/>
                <a href="tel:+919982866666">+91- 9982866666</a>
              </p>
            </div>
          </div>
        ...
        <div className="green-footer-middle">
          <div className="green-footer-policies">
            ...
            <Link to="/tickets">Terms & Conditions</Link>
          ...
          <div className="green-footer-social">
            ...
            <div className="green-social-icons">
               <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="green-icon" aria-label="Facebook">
                 <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
                   <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/>
                 </svg>
               </a>
               <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="green-icon" aria-label="Instagram">
                 <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
               ...
               <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="green-icon" aria-label="YouTube">
                 <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
                   <path d="M23.498 6.163a3.003 3.003 0 0 0-2.11-2.11C19.518 3.545 12 3.545 12 3.545s-7.518 0-9.388.507a3.003 3.003 0 0 0-2.11 2.11C0 8.033 0 12 0 12s0 3.967.502 5.837a3.003 3.003 0 0 0 2.11 2.11c1.87.507 9.388.507 9.388.507s7.518 0 9.388-.507a3.003 3.003 0 0 0 2.11-2.11C24 15.967 24 12 24 12s0-3.967-.502-5.837zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                 </svg>
               </a>
               <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="green-icon" aria-label="X (Twitter)">
