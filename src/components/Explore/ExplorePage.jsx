...
export default function ExplorePage() {
  ...
  return (
    <div className="explore-page-wrapper">
      ...
      {/* ΓöÇΓöÇ SCHEDULE SECTION ΓöÇΓöÇ */}
      <section className="schedule-section">
        ...
        <div className="schedule-content">
          ...
          {/* ΓöÇΓöÇ PDF VIEWER MOCKUP ΓöÇΓöÇ */}
      ...
      {/* ΓöÇΓöÇ THURSDAY SECTION (DAY 1) ΓöÇΓöÇ */}
                ...
                <div className="card-footer">
                  ...
                  <Link to="/tickets" style={{ textDecoration: 'none' }}>
                    <button className="card-read-more-btn">
                      READ MORE <span className="arrow-icon">ΓåÆ</span>
                    </button>
                  </Link>
                </div>
              </div>
      ...
      {/* ΓöÇΓöÇ FRIDAY SECTION (DAY 2) ΓöÇΓöÇ */}
